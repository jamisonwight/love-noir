...
jQuery(function($) {
	...
	/*!
		...
		av_showmodal = function() {
			...
			var content_agegate = $('<article class="content_forms" role="tablist" aria-label="Age Gate"><p style="margin-bottom:20px;"><label for="agree" class="show-for-sr">I agree to the Terms of Service and Privacy Policy</label><input type="checkbox" id="agree" required name="agree" role="tab" aria-selected="true" tabindex="1"></input> I agree to the <a data-fancybox data-type="iframe" data-src="/terms-of-service.html" aria-disabled="true">Terms of Service</a> and <a data-fancybox data-type="iframe" data-src="/privacy-policy.html" aria-disabled="true">Privacy Policy</a></p><article class="flex"><h1>Are you of legal drinking age?</h1><nav><ul><li><a href="#" class="av_btn av_go" rel="yes" id="yes" role="tab" tabindex="2">Yes</a></li><li><a href="#" class="av_btn av_no" rel="no" id="no" role="tab" tabindex="3">No</a></li></nav></article><article class="flex"><article class="caption"><p role="heading">You must be at least 21 years old to view this site.<br> By clicking “yes” you affirm that you are at least 21 years old. </p><article class="caption"><p>You can learn more about how we use cookies by reviewing our <a style="color: inherit; text-decoration: underline;" data-fancybox="" data-type="iframe" data-src="/privacy-policy.html" href="javascript:;" aria-disabled="true">Privacy Policy</a>.</p></article></article></article><article class="copyright"><p class="source-org">&copy;<?php echo date("Y"); ?> Love Noir Vineyards, Ripon, CA</p></article></article>');
