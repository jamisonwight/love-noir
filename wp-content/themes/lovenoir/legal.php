...
<div class="<?php echo ($lg_classes) ? $lg_classes : 'legal' ; ?>">
  <div class="<?php echo ($lg_wrap_classes) ? $lg_wrap_classes : 'legal-wrap'; ?>">
    ...
    <?php if ($page_slug == $privacy_page_title) : ?>
            ...
            <div id="ccpa" style="position: relative; top: -75px;"></div>
            ...
            <p>You or your designated authorized agent can make a Request to Know the personal information we have about you by filling out our online form available <a href="https://thewinegroup.com/ccpa-request/?recipient=lovenoir" target="_blank">here</a> or emailing us at <a href="mailto:privacy@thewinegroup.com">privacy@thewinegroup.com</a>. </p>
            ...
            <p>To submit a request, <a href="https://thewinegroup.com/ccpa-request/?recipient=lovenoir" target="_blank">click here</a> or email us at <a href="mailto:privacy@thewinegroup.com">privacy@thewinegroup.com</a>. </p>
      ...
      <?php elseif ($page_slug === $terms_page_title) : ?>
            ...
            <p>Notices and counter-notices must be sent in writing to our designated DMCA agent as follows: By mail to GENERAL COUNSEL, The Wine Group LLC, 17000 East Highway 120, Ripon, CA 95336; by e-mail to <a href="mailto:copyright@TheWineGroup.com">copyright@TheWineGroup.com</a>. You can also reach our DMCA agent at the following telephone number: 925-456-2500.</p>
